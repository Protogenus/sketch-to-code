              ...
              {!uploadedImage ? (
                ...
                >
                  ...
                  <div className="bg-indigo-50 rounded-lg p-3 text-sm text-indigo-700">
                    ...
                    <p>Use text labels OR colors! Text labels override colors if conflicted. Blue=Cards, Green=Hero/CTA, Red=Buttons, Orange=Pricing, Purple=Testimonials, Yellow=Forms, Gray=Nav/Footer, Teal=Sidebar.</p>
                  </div>
                </div>
              ) : (
