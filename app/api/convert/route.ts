...
- Look for handwritten labels and create appropriate HTML elements:
...
- **Content:** "Blog" → blog layout, "Article" → <article>, "Form" → contact form, "Grid" → grid container, "Card" → card components
